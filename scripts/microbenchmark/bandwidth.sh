...
_3_LOG=${DIR_PATH}/bw_3.log
rm $_3_LOG
_7_LOG=${DIR_PATH}/bw_7.log
rm $_7_LOG
_8_LOG=${DIR_PATH}/bw_8.log
rm $_8_LOG
_32_LOG=${DIR_PATH}/bw_32.log
rm $_32_LOG
...
for idx in `seq 32 63`; do
	...
	make -j 16
	cd ..
	numactl --physcpubind=32-$idx ./bin/bandwidth >> $_3_LOG 2>&1
	cd ${CUR_DIR}
	...
	make -j 16
	cd ..
	numactl --physcpubind=32-$idx ./bin/bandwidth >> $_7_LOG 2>&1
	cd ${CUR_DIR}
	...
	make -j 16
	cd ..
	numactl --physcpubind=32-$idx ./bin/bandwidth >> $_8_LOG 2>&1
	cd ${CUR_DIR}
	...
	make -j 16
	cd ..
	numactl --physcpubind=32-$idx --interleave=7,8 ./bin/bandwidth >> $_32_LOG 2>&1
	cd ${CUR_DIR}
done

...
_3_LOG=${DIR_PATH}/skip_3.log
rm $_3_LOG
_7_LOG=${DIR_PATH}/skip_7.log
rm $_7_LOG
_8_LOG=${DIR_PATH}/skip_8.log
rm $_8_LOG
_32_LOG=${DIR_PATH}/skip_32.log
rm $_32_LOG
...
make -j 16
cd ..
numactl --physcpubind=32-63 ./bin/skip >> $_3_LOG 2>&1
cd ${CUR_DIR}
...
make -j 16
cd ..
numactl --physcpubind=32-63 ./bin/skip >> $_7_LOG 2>&1
cd ${CUR_DIR}
...
make -j 16
cd ..
numactl --physcpubind=32-63 ./bin/skip >> $_8_LOG 2>&1
cd ${CUR_DIR}
...
make -j 16
cd ..
numactl --physcpubind=32-63 --interleave=7,8 ./bin/skip >> $_32_LOG 2>&1
cd ${CUR_DIR}
